                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" v-model="form.disc3Pc" name="disc3Pc"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                       placeholder="" />
                                <div v-if="form.errors.disc3Pc" class="text-sm text-red-600">
                                    {{ form.errors.disc3Pc }}
                                </div>
                            </div>
                            <div class="mb-6">
                                ...
                                <input type="text" v-model="form.disc5Pc" name="disc5Pc"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                       placeholder="" />
                                <div v-if="form.errors.disc5Pc" class="text-sm text-red-600">
                                    {{ form.errors.disc5Pc }}
                                </div>
                            </div>
                            <button type="submit"
